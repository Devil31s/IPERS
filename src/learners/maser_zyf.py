...
##############################################################################################################################
        ...
        if self.goal == "maser":
            ...
            q_selected_weight = th.sum(q_selected_weight).sum() / th.mean(ind_mask, dim=-1).sum()
            #print(q_selected_weight.shape)
            #print(masked_td_individual_error.shape)
            ...
            #print("看看individual loss的shape:",  individual_loss.shape)
            loss += 0.001 * self.ind*individual_loss * q_selected_weight + 0.001 * self.mix*mix_explore_distance_loss
